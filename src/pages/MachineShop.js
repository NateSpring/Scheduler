...
function MachineShop() {
  const { hopper, operatorData, setOperatorData } = useContext(HopperContext);
  ...
  return (
    <>
      <div className="flex flex-row items-center justify-between">
        <PageTitle>MACHINE SHOP</PageTitle>
        <ScanModal scanDept={2} />
      </div>
      <TableContainer>
            ...
            <TableContainer key={i}>
              <div className="h-auto px-4 py-4 bg-gray-200 dark:bg-gray-800 m-2 rounded flex flex-col ">
                <div className="flex flex-col md:flex-row justify-center">
                  <div className="flex items-center justify-center text-6xl font-bold bg-gray-900 items rounded-none md:rounded-tl-lg shadow-lg text-gray-50 dark:text-gray-200 text-center p-2 md:w-1/2">
                    <h2>{cell}</h2>
                  </div>
                  <div className="flex flex-col items-center justify-center md:rounded-tr-lg md:w-1/2 bg-gray-900 pt-2">
