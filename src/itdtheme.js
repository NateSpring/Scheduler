export default {
  ...
  modal: {
    ...
    danger:
      "w-full px-6 py-4 overflow-hidden bg-red-500 rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl",
  },
  // ModalBody
  modalBody: {
  ...
  // ModalHeader
  modalHeader: {
    base: "mt-4 mb-2 text-4xl font-semibold text-gray-700 dark:text-gray-300",
  },
  // Badge
  badge: {
